...
bash ${MY_PATH}/recalibration_genpipes.sh $TUMOR $REF $KNOWNSITES1 $KNOWNSITES2 $KNOWNSITES3 $PREVIOUS

bash ${MY_PATH}/recalibration_genpipes.sh $NORMAL $REF $KNOWNSITES1 $KNOWNSITES2 $KNOWNSITES3 $PREVIOUS
