...
bash ${MY_PATH}/recalibration_4.1_500.sh $TUMOR $REF $KNOWNSITES1 $KNOWNSITES2 $KNOWNSITES3 $PREVIOUS

bash ${MY_PATH}/recalibration_4.1_500.sh $NORMAL $REF $KNOWNSITES1 $KNOWNSITES2 $KNOWNSITES3 $PREVIOUS
